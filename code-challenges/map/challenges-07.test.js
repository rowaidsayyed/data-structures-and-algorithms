...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach((e)=>{
    let sum =2
    let anyArr= new Array(Math.abs(e)).fill(2);
    anyArr.forEach((e) =>{
      sum *= e;
    });
    if(e===0)newArr.push(1);
...
forLoopTwoToThe function from challenge 1 and your forEachTwoToThe function from challenge 2,
