...
const matchMonth = (input) => {
  // Solution code here...
  let regX = /\b(October|Oct|october|oct)\b/g;
  return regX.test(input);
};
...
let hangman = (str) => {
  // Solution code here...
  let regX = /[aeiou]/gi;
  return str.replace(regX,'_')||[];
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 7 - Stretch Goal

Write a function named findShells that takes in the string below and uses a regular expression pattern to
find all instances of the following words: "sells", "shells", "seashells".
